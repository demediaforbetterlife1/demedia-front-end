      ...
      <div className="min-h-screen p-4">
        <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-xl">
          <div className="p-6 border-b">
            <h2 className="text-2xl font-bold text-gray-900">Image Debug Test</h2>
                  ...
                  <div className="relative h-32 bg-gray-100 rounded border overflow-hidden">
                    {result.status === 'success' ? (
                      <MediaImage
                        ...
                        fill
                        onError={() => console.log('MediaImage error for:', result.url)}
                        onLoad={() => console.log('MediaImage loaded:', result.url)}
                      />
                    ) : result.status === 'error' ? (
              ...
              <div className="mt-6 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="text-sm text-gray-600">
                  ...
                  <div className="text-yellow-600">
                    Loading: {testResults.filter(r => r.status === 'loading').length}
                  </div>
